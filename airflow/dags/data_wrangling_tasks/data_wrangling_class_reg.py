...
def main_data_wrangling():
    ...
    response = s3.list_objects_v2(Bucket=bucket_name, Prefix=f'{prefix}/daily_feed')
    ...
    output_prefix = f'{prefix}/daily_feed_pred/Daily_Product_Data_Cleaned.csv'
    csv_buffer = StringIO()
